...
public class addConsultatie extends op2{

	public addConsultatie(String s1, String s2, Service s)
	{
		super(s1,s2,s);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(s.equals("adauga")) {
			...
			op2.s.addConsultatie(Integer.parseInt(t[0].getText()),
					t[2].getText(),t[1].getText(),t[3].getText(),
					t[4].getText(),t[5].getText());
			l.setText("Consultatie adaugata!");
		}
	}
